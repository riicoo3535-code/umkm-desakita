...
if (isset($_POST['btn_simpan'])) {
    ...
    // opsional: jika kosong, default diset ke 0
    $harga           = (isset($_POST['harga']) && $_POST['harga'] !== '') ? (int)$_POST['harga'] : 0;
    $stok            = (isset($_POST['stok']) && $_POST['stok'] !== '') ? (int)$_POST['stok'] : 0;
    
    $id_umkm = 0;
    $kategori_id = 0;

    // Validasi Isian Kosong (Harga & Stok tidak lagi diwajibkan)
    ...
    // HANDLER OTOMATISASI KATEGORI TEKS KE ID
    if ($notif === "") {
...
<div class="container" style="max-width: 700px;">
    ...
    <!-- TAMPILAN NOTIFIKASI ERROR VALIDASI -->
    ...
    <div class="card card-custom p-4 p-md-5">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-6 mb-3">
                    <label class="form-label small fw-semibold text-secondary">Harga Satuan (Rp) <span class="text-muted fw-normal">(Opsional)</span></label>
                    <div class="input-group">
                        <span class="input-group-text bg-light border-end-0 text-muted small">Rp</span>
                        <input type="number" name="harga" class="form-control border-start-0" placeholder="0" min="0">
                    </div>
                </div>
                
                <div class="col-sm-6 mb-3">
                    <label class="form-label small fw-semibold text-secondary">Stok Produk <span class="text-muted fw-normal">(Opsional)</span></label>
                    <input type="number" name="stok" class="form-control" placeholder="0" min="0">
                </div>
            </div>

            <div class="mb-4">
                <label class="form-label small fw-semibold text-secondary">Foto Produk Ilustrasi <span class="text-muted fw-normal">(Opsional)</span></label>
